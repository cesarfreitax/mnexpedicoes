package com.cesar.mnexpedicoes.features.events.presentation
...
import com.cesar.mnexpedicoes.features.events.cell.ItemIncludedCell
import com.cesar.mnexpedicoes.features.events.cell.TicketCell
import com.cesar.mnexpedicoes.features.home.model.EventResponse
import com.cesar.mnexpedicoes.features.home.model.Included
import com.cesar.mnexpedicoes.features.home.model.NotIncluded
import com.cesar.mnexpedicoes.features.home.model.Ticket
...
class EventDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        event = arguments?.getSerializable("event") as? EventResponse
        setupFragment(event ?: EventResponse())
    }
    ...
    private fun setupFragmentView(event: EventResponse) {
        ...
        if (event.type == Constants.EVENT_TYPE_TRIP) {
    ...
    private fun setupButtons() {
        ...
        setupWhatsappPaymentButton()
    }

    private fun setupWhatsappPaymentButton() {
