package com.cesar.mnexpedicoes.fragments.login.register.presentation
...
import com.cesar.mnexpedicoes.fragments.login.register.password.TogglePasswordAction
import com.cesar.mnexpedicoes.fragments.login.register.validation.InputsValidation
...
class RegisterFragment : Fragment() {
    ...
    private fun showError() {
        ...
        this.makeToastError(getString(R.string.error_register_phone))
    }
    ...
    private fun postUser() {
        ...
        viewModel.postUser(user) {
            ...
            if (viewModel.userCreatedSuccessfull) {
                this.makeToastSuccess("Conta criada com sucesso!")
                navigateToHome()
            } else {
                this.makeToastError(getString(R.string.default_error))
            }
        }
    }
